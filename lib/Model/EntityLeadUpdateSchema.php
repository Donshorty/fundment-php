...
/**
 * EntityLeadUpdateSchema Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EntityLeadUpdateSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EntityLeadUpdateSchema';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^[A-Z]{2}$/", $this->container['country_of_incorporation'])) {
    ...
    public function setCountryOfTaxResidency($country_of_tax_residency)
    {
        ...
        if ((!preg_match("/^[A-Z]{2}$/", ObjectSerializer::toString($country_of_tax_residency)))) {
            throw new \InvalidArgumentException("invalid value for \$country_of_tax_residency when calling EntityLeadUpdateSchema., must conform to the pattern /^[A-Z]{2}$/.");
        }
    ...
    public function setLei($lei)
    {
        ...
        if ((!preg_match("/^[A-Z,0-9]{18}[0-9]{2}/", ObjectSerializer::toString($lei)))) {
            throw new \InvalidArgumentException("invalid value for \$lei when calling EntityLeadUpdateSchema., must conform to the pattern /^[A-Z,0-9]{18}[0-9]{2}/.");
        }
     ...
     *
     * @param string $country_of_incorporation Must be a string of letters of length 2, based on the ISO alpha-2 codes
     *
     * @return self
     */
    public function setCountryOfIncorporation($country_of_incorporation)
    {
        ...
        if ((!preg_match("/^[A-Z]{2}$/", ObjectSerializer::toString($country_of_incorporation)))) {
            throw new \InvalidArgumentException("invalid value for \$country_of_incorporation when calling EntityLeadUpdateSchema., must conform to the pattern /^[A-Z]{2}$/.");
        }

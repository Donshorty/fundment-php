...
/**
 * SecurityValuationReturnSchema Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SecurityValuationReturnSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SecurityValuationReturnSchema';
    ...
    */
    ...
    public function setUnitPrice($unit_price)
    {
        ...
        if (($unit_price < 0.0)) {
            throw new \InvalidArgumentException('invalid value for $unit_price when calling SecurityValuationReturnSchema., must be bigger than or equal to 0.0.');
        }
    ...
    public function setUnitGbpPrice($unit_gbp_price)
    {
        ...
        if (($unit_gbp_price < 0.0)) {
            throw new \InvalidArgumentException('invalid value for $unit_gbp_price when calling SecurityValuationReturnSchema., must be bigger than or equal to 0.0.');
        }
     ...
     * Sets security_id
     *
     * @param int $security_id security_id
     *
     * @return self
     */
     ...
     *
     * @param string $settlement_currency settlement_currency
     *
     * @return self
     */

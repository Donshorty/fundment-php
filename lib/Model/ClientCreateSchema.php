...
/**
 * ClientCreateSchema Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ClientCreateSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ClientCreateSchema';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['nino']) && !preg_match("/^(?!BG)(?!GB)(?!NK)(?!KN)(?!TN)(?!NT)(?!ZZ)(?:[A-CEGHJ-PR-TW-Z][A-CEGHJ-NPR-TW-Z])(?:\\d){6}([A-D]|\\s)$/", $this->container['nino'])) {
    ...
    public function setTitle($title)
    {
        ...
        if ((!preg_match("/^[A-Za-z]+$/", ObjectSerializer::toString($title)))) {
            throw new \InvalidArgumentException("invalid value for \$title when calling ClientCreateSchema., must conform to the pattern /^[A-Za-z]+$/.");
        }
    ...
    public function setCountryOfBirth($country_of_birth)
    {
        ...
        if ((!preg_match("/^[A-Z]{2}$/", ObjectSerializer::toString($country_of_birth)))) {
            throw new \InvalidArgumentException("invalid value for \$country_of_birth when calling ClientCreateSchema., must conform to the pattern /^[A-Z]{2}$/.");
        }
    ...
    public function setNationality($nationality)
    {
        ...
        if ((!preg_match("/^[A-Z]{2}$/", ObjectSerializer::toString($nationality)))) {
            throw new \InvalidArgumentException("invalid value for \$nationality when calling ClientCreateSchema., must conform to the pattern /^[A-Z]{2}$/.");
        }
    ...
    public function setCountryOfTaxResidency($country_of_tax_residency)
    {
        ...
        if ((!preg_match("/^[A-Z]{2}$/", ObjectSerializer::toString($country_of_tax_residency)))) {
            throw new \InvalidArgumentException("invalid value for \$country_of_tax_residency when calling ClientCreateSchema., must conform to the pattern /^[A-Z]{2}$/.");
        }
     ...
     * Sets nino
     *
     * @param string|null $nino NI number must be valid as per Government guidelines
     *
     * @return self
     */
    public function setNino($nino)
    {
        ...
        if ((!preg_match("/^(?!BG)(?!GB)(?!NK)(?!KN)(?!TN)(?!NT)(?!ZZ)(?:[A-CEGHJ-PR-TW-Z][A-CEGHJ-NPR-TW-Z])(?:\\d){6}([A-D]|\\s)$/", ObjectSerializer::toString($nino)))) {
            throw new \InvalidArgumentException("invalid value for \$nino when calling ClientCreateSchema., must conform to the pattern /^(?!BG)(?!GB)(?!NK)(?!KN)(?!TN)(?!NT)(?!ZZ)(?:[A-CEGHJ-PR-TW-Z][A-CEGHJ-NPR-TW-Z])(?:\\d){6}([A-D]|\\s)$/.");
        }
    ...
    public function setPhoneNumber($phone_number)
    {
        ...
        if ((!preg_match("/^\\s*(?:\\+?(\\d{1,6}))?[-.\\s(]*(\\d{1,6})[-.\\s)]*(\\d{1,6})([-.\\s]*(\\d{1,6})[-.\\s]*)?([-.\\s]*(\\d{1,6})[-.\\s]*)?([-.\\s]*(\\d{1,6})[-.\\s]*)?(?: *(\\d+))?\\s*$/", ObjectSerializer::toString($phone_number)))) {
            throw new \InvalidArgumentException("invalid value for \$phone_number when calling ClientCreateSchema., must conform to the pattern /^\\s*(?:\\+?(\\d{1,6}))?[-.\\s(]*(\\d{1,6})[-.\\s)]*(\\d{1,6})([-.\\s]*(\\d{1,6})[-.\\s]*)?([-.\\s]*(\\d{1,6})[-.\\s]*)?([-.\\s]*(\\d{1,6})[-.\\s]*)?(?: *(\\d+))?\\s*$/.");
        }

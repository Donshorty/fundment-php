...
/**
 * InvestmentManagementFirmOptionsCreateSchema Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InvestmentManagementFirmOptionsCreateSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvestmentManagementFirmOptionsCreateSchema';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('analysis_period_years', $data ?? [], 5);
        $this->setIfExists('fee_charge_frequency', $data ?? [], null);
        $this->setIfExists('fee_type', $data ?? [], null);
        $this->setIfExists('initial_fee_on_recurring_deposit', $data ?? [], 0);
        $this->setIfExists('enable_custom_index', $data ?? [], false);
    ...
    */
    ...
    public function setDmNino($dm_nino)
    {
        ...
        if ((mb_strlen($dm_nino) > 9)) {
            throw new \InvalidArgumentException('invalid length for $dm_nino when calling InvestmentManagementFirmOptionsCreateSchema., must be smaller than or equal to 9.');
        }
    ...
    public function setAcknowledgementTcs($acknowledgement_tcs)
    {
        ...
        if ((mb_strlen($acknowledgement_tcs) > 4)) {
            throw new \InvalidArgumentException('invalid length for $acknowledgement_tcs when calling InvestmentManagementFirmOptionsCreateSchema., must be smaller than or equal to 4.');
        }
    ...
    public function setRetailAcknowledgementFull($retail_acknowledgement_full)
    {
        ...
        if ((mb_strlen($retail_acknowledgement_full) > 4)) {
            throw new \InvalidArgumentException('invalid length for $retail_acknowledgement_full when calling InvestmentManagementFirmOptionsCreateSchema., must be smaller than or equal to 4.');
        }
    ...
    public function setRetailAcknowledgementMandate($retail_acknowledgement_mandate)
    {
        ...
        if ((mb_strlen($retail_acknowledgement_mandate) > 4)) {
            throw new \InvalidArgumentException('invalid length for $retail_acknowledgement_mandate when calling InvestmentManagementFirmOptionsCreateSchema., must be smaller than or equal to 4.');
        }
     ...
     *
     * @param int|null $initial_fee_on_recurring_deposit initial_fee_on_recurring_deposit
     *
     * @return self
     */
     ...
     *
     * @param bool|null $enable_custom_index enable_custom_index
     *
     * @return self
     */

<?php
/**
 * InvestmentManagementFirmDetailsUpdateSchema
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * InvestmentManagementFirmDetailsUpdateSchema Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InvestmentManagementFirmDetailsUpdateSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvestmentManagementFirmDetailsUpdateSchema';
    ...
    */
    ...
    public function setPhoneNumber($phone_number)
    {
        ...
        if ((!preg_match("/^\\s*(?:\\+?(\\d{1,6}))?[-.\\s(]*(\\d{1,6})[-.\\s)]*(\\d{1,6})([-.\\s]*(\\d{1,6})[-.\\s]*)?([-.\\s]*(\\d{1,6})[-.\\s]*)?([-.\\s]*(\\d{1,6})[-.\\s]*)?(?: *(\\d+))?\\s*$/", ObjectSerializer::toString($phone_number)))) {
            throw new \InvalidArgumentException("invalid value for \$phone_number when calling InvestmentManagementFirmDetailsUpdateSchema., must conform to the pattern /^\\s*(?:\\+?(\\d{1,6}))?[-.\\s(]*(\\d{1,6})[-.\\s)]*(\\d{1,6})([-.\\s]*(\\d{1,6})[-.\\s]*)?([-.\\s]*(\\d{1,6})[-.\\s]*)?([-.\\s]*(\\d{1,6})[-.\\s]*)?(?: *(\\d+))?\\s*$/.");
        }
    ...
    public function setFcaRegistrationNumber($fca_registration_number)
    {
        ...
        if ((!preg_match("/^1?[0-9]{6}$/", ObjectSerializer::toString($fca_registration_number)))) {
            throw new \InvalidArgumentException("invalid value for \$fca_registration_number when calling InvestmentManagementFirmDetailsUpdateSchema., must conform to the pattern /^1?[0-9]{6}$/.");
        }

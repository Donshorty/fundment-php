...
/**
 * FeeAccountBalanceReturnSchema Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FeeAccountBalanceReturnSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FeeAccountBalanceReturnSchema';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['cash_balance'] === null) {
            $invalidProperties[] = "'cash_balance' can't be null";
        }
    ...
    public function setCashBalance($cash_balance)
    {
        if (is_null($cash_balance)) {
            throw new \InvalidArgumentException('non-nullable cash_balance cannot be null');
        }

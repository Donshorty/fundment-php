...
/**
 * ClientAppReturnSchema Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ClientAppReturnSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ClientAppReturnSchema';
    ...
    */
    ...
    public function setNetworkCode($network_code)
    {
        ...
        if ((mb_strlen($network_code) > 6)) {
            throw new \InvalidArgumentException('invalid length for $network_code when calling ClientAppReturnSchema., must be smaller than or equal to 6.');
        }

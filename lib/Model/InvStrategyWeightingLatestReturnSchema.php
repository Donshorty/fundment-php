<?php
/**
 * InvStrategyWeightingLatestReturnSchema
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * InvStrategyWeightingLatestReturnSchema Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InvStrategyWeightingLatestReturnSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvStrategyWeightingLatestReturnSchema';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['weighting'] === null) {
            $invalidProperties[] = "'weighting' can't be null";
        }
     ...
     * Sets weighting
     *
     * @param float $weighting weighting
     *
     * @return self
     */

...
/**
 * AdviserFirmOptionUpdateSchema Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AdviserFirmOptionUpdateSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdviserFirmOptionUpdateSchema';
    ...
    */
    ...
    public function setIoTenantId($io_tenant_id)
    {
        ...
        if ((!preg_match("/^[0-9]+$/", ObjectSerializer::toString($io_tenant_id)))) {
            throw new \InvalidArgumentException("invalid value for \$io_tenant_id when calling AdviserFirmOptionUpdateSchema., must conform to the pattern /^[0-9]+$/.");
        }

<?php
/**
 * NestedInstitutionBankAccountReturnSchema
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * NestedInstitutionBankAccountReturnSchema Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class NestedInstitutionBankAccountReturnSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NestedInstitutionBankAccountReturnSchema';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^[0-9]+$/", $this->container['sort_code'])) {
        ...
        if (!preg_match("/^[0-9]+$/", $this->container['account_number'])) {
     ...
     * Sets sort_code
     *
     * @param string $sort_code Must be a string of numbers
     *
     * @return self
     */
    public function setSortCode($sort_code)
    {
        ...
        if ((!preg_match("/^[0-9]+$/", ObjectSerializer::toString($sort_code)))) {
            throw new \InvalidArgumentException("invalid value for \$sort_code when calling NestedInstitutionBankAccountReturnSchema., must conform to the pattern /^[0-9]+$/.");
        }
     ...
     * Sets account_number
     *
     * @param string $account_number Must be a string of numbers
     *
     * @return self
     */
    public function setAccountNumber($account_number)
    {
        ...
        if ((!preg_match("/^[0-9]+$/", ObjectSerializer::toString($account_number)))) {
            throw new \InvalidArgumentException("invalid value for \$account_number when calling NestedInstitutionBankAccountReturnSchema., must conform to the pattern /^[0-9]+$/.");
        }

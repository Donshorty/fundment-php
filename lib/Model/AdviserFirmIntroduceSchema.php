...
/**
 * AdviserFirmIntroduceSchema Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AdviserFirmIntroduceSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdviserFirmIntroduceSchema';
    ...
    */
    ...
    public function setPhoneNumber($phone_number)
    {
        ...
        if ((!preg_match("/^\\s*(?:\\+?(\\d{1,6}))?[-.\\s(]*(\\d{1,6})[-.\\s)]*(\\d{1,6})([-.\\s]*(\\d{1,6})[-.\\s]*)?([-.\\s]*(\\d{1,6})[-.\\s]*)?([-.\\s]*(\\d{1,6})[-.\\s]*)?(?: *(\\d+))?\\s*$/", ObjectSerializer::toString($phone_number)))) {
            throw new \InvalidArgumentException("invalid value for \$phone_number when calling AdviserFirmIntroduceSchema., must conform to the pattern /^\\s*(?:\\+?(\\d{1,6}))?[-.\\s(]*(\\d{1,6})[-.\\s)]*(\\d{1,6})([-.\\s]*(\\d{1,6})[-.\\s]*)?([-.\\s]*(\\d{1,6})[-.\\s]*)?([-.\\s]*(\\d{1,6})[-.\\s]*)?(?: *(\\d+))?\\s*$/.");
        }
    ...
    public function setFcaRegistrationNumber($fca_registration_number)
    {
        ...
        if ((!preg_match("/^1?[0-9]{6}$/", ObjectSerializer::toString($fca_registration_number)))) {
            throw new \InvalidArgumentException("invalid value for \$fca_registration_number when calling AdviserFirmIntroduceSchema., must conform to the pattern /^1?[0-9]{6}$/.");
        }
    ...
    public function setAddresses($addresses)
    {
        ...
        if ((count($addresses) < 1)) {
            throw new \InvalidArgumentException('invalid length for $addresses when calling AdviserFirmIntroduceSchema., number of items must be greater than or equal to 1.');
        }
    ...
    public function setCompaniesHouseRegistrationNumber($companies_house_registration_number)
    {
        ...
        if ((!preg_match("/^((AC|FC|GE|GN|GS|IC|IP|LP|NA|NF|NI|NL|NO|NP|NR|NZ|OC|R|RC|SA|SC|SF|SI|SL|SO|SP|SR|SZ|ZC)|\\d?\\d)(\\d{6})$/", ObjectSerializer::toString($companies_house_registration_number)))) {
            throw new \InvalidArgumentException("invalid value for \$companies_house_registration_number when calling AdviserFirmIntroduceSchema., must conform to the pattern /^((AC|FC|GE|GN|GS|IC|IP|LP|NA|NF|NI|NL|NO|NP|NR|NZ|OC|R|RC|SA|SC|SF|SI|SL|SO|SP|SR|SZ|ZC)|\\d?\\d)(\\d{6})$/.");
        }

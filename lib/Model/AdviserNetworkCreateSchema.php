...
/**
 * AdviserNetworkCreateSchema Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AdviserNetworkCreateSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdviserNetworkCreateSchema';
    ...
    */
    ...
    public function setRef($ref)
    {
        ...
        if ((mb_strlen($ref) > 6)) {
            throw new \InvalidArgumentException('invalid length for $ref when calling AdviserNetworkCreateSchema., must be smaller than or equal to 6.');
        }

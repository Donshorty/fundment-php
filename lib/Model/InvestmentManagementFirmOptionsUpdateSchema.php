...
/**
 * InvestmentManagementFirmOptionsUpdateSchema Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InvestmentManagementFirmOptionsUpdateSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvestmentManagementFirmOptionsUpdateSchema';
    ...
    */
    ...
    public function setDmNino($dm_nino)
    {
        ...
        if ((mb_strlen($dm_nino) > 9)) {
            throw new \InvalidArgumentException('invalid length for $dm_nino when calling InvestmentManagementFirmOptionsUpdateSchema., must be smaller than or equal to 9.');
        }
    ...
    public function setAcknowledgementTcs($acknowledgement_tcs)
    {
        ...
        if ((mb_strlen($acknowledgement_tcs) > 4)) {
            throw new \InvalidArgumentException('invalid length for $acknowledgement_tcs when calling InvestmentManagementFirmOptionsUpdateSchema., must be smaller than or equal to 4.');
        }
    ...
    public function setRetailAcknowledgementFull($retail_acknowledgement_full)
    {
        ...
        if ((mb_strlen($retail_acknowledgement_full) > 4)) {
            throw new \InvalidArgumentException('invalid length for $retail_acknowledgement_full when calling InvestmentManagementFirmOptionsUpdateSchema., must be smaller than or equal to 4.');
        }
    ...
    public function setRetailAcknowledgementMandate($retail_acknowledgement_mandate)
    {
        ...
        if ((mb_strlen($retail_acknowledgement_mandate) > 4)) {
            throw new \InvalidArgumentException('invalid length for $retail_acknowledgement_mandate when calling InvestmentManagementFirmOptionsUpdateSchema., must be smaller than or equal to 4.');
        }

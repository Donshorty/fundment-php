...
/**
 * EntityClientReturnSchema Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EntityClientReturnSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EntityClientReturnSchema';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['country_of_incorporation'] === null) {
            $invalidProperties[] = "'country_of_incorporation' can't be null";
        }
     ...
     *
     * @param string $country_of_tax_residency country_of_tax_residency
     *
     * @return self
     */
     ...
     *
     * @param string $country_of_incorporation country_of_incorporation
     *
     * @return self
     */

...
/**
 * ClientAppUpdateSchema Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ClientAppUpdateSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ClientAppUpdateSchema';
    ...
    */
    ...
    public function setRedirectUri($redirect_uri)
    {
        ...
        if ((mb_strlen($redirect_uri) > 2083)) {
            throw new \InvalidArgumentException('invalid length for $redirect_uri when calling ClientAppUpdateSchema., must be smaller than or equal to 2083.');
        }
        if ((mb_strlen($redirect_uri) < 1)) {
            throw new \InvalidArgumentException('invalid length for $redirect_uri when calling ClientAppUpdateSchema., must be bigger than or equal to 1.');
        }

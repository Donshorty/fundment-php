...
/**
 * InvestmentManagementFirmAddressCreateSchema Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InvestmentManagementFirmAddressCreateSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvestmentManagementFirmAddressCreateSchema';
    ...
    */
    ...
    public function setCountry($country)
    {
        ...
        if ((!preg_match("/^[A-Z]{2}$/", ObjectSerializer::toString($country)))) {
            throw new \InvalidArgumentException("invalid value for \$country when calling InvestmentManagementFirmAddressCreateSchema., must conform to the pattern /^[A-Z]{2}$/.");
        }

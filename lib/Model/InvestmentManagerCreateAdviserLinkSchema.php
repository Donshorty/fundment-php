<?php
/**
 * InvestmentManagerCreateAdviserLinkSchema
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * InvestmentManagerCreateAdviserLinkSchema Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InvestmentManagerCreateAdviserLinkSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvestmentManagerCreateAdviserLinkSchema';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['adviser_ref'] === null) {
            $invalidProperties[] = "'adviser_ref' can't be null";
        }
     ...
     * Sets adviser_ref
     *
     * @param int $adviser_ref adviser_ref
     *
     * @return self
     */

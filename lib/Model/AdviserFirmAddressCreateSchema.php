<?php
/**
 * AdviserFirmAddressCreateSchema
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * AdviserFirmAddressCreateSchema Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AdviserFirmAddressCreateSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdviserFirmAddressCreateSchema';
    ...
    */
    ...
    public function setCountry($country)
    {
        ...
        if ((!preg_match("/^[A-Z]{2}$/", ObjectSerializer::toString($country)))) {
            throw new \InvalidArgumentException("invalid value for \$country when calling AdviserFirmAddressCreateSchema., must conform to the pattern /^[A-Z]{2}$/.");
        }

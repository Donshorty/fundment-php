...
/**
 * InvestmentManagementFirmAddressReturnSchema Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InvestmentManagementFirmAddressReturnSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvestmentManagementFirmAddressReturnSchema';
    ...
    */
    ...
    public function setCountry($country)
    {
        ...
        if ((!preg_match("/^[A-Z]{2}$/", ObjectSerializer::toString($country)))) {
            throw new \InvalidArgumentException("invalid value for \$country when calling InvestmentManagementFirmAddressReturnSchema., must conform to the pattern /^[A-Z]{2}$/.");
        }

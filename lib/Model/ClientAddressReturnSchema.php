...
/**
 * ClientAddressReturnSchema Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ClientAddressReturnSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ClientAddressReturnSchema';
    ...
    */
    ...
    public function setCountry($country)
    {
        ...
        if ((!preg_match("/^[A-Z]{2}$/", ObjectSerializer::toString($country)))) {
            throw new \InvalidArgumentException("invalid value for \$country when calling ClientAddressReturnSchema., must conform to the pattern /^[A-Z]{2}$/.");
        }
    ...
    public function setRef($ref)
    {
        ...
        if ((mb_strlen($ref) > 50)) {
            throw new \InvalidArgumentException('invalid length for $ref when calling ClientAddressReturnSchema., must be smaller than or equal to 50.');
        }

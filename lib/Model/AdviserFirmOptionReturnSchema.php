...
/**
 * AdviserFirmOptionReturnSchema Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AdviserFirmOptionReturnSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdviserFirmOptionReturnSchema';
    ...
    protected static $openAPITypes = [
        ...
        'set_default_user_email_to_fundment' => 'bool',
        'receives_consulting_services_fees' => 'bool',
        'generate_illustration_on_payments' => 'bool',
        'firm_fees_label' => 'string',
        'consulting_services_label' => 'string',
        'date_updated' => '\DateTime',
        'additional_portfolio_analytics' => 'bool',
        'enable_multi_factor_authentication' => 'bool',
    ...
    protected static $openAPIFormats = [
        ...
        'set_default_user_email_to_fundment' => null,
        'receives_consulting_services_fees' => null,
        'generate_illustration_on_payments' => null,
        'firm_fees_label' => null,
        'consulting_services_label' => null,
        'date_updated' => 'date-time',
        'additional_portfolio_analytics' => null,
        'enable_multi_factor_authentication' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'set_default_user_email_to_fundment' => false,
        'receives_consulting_services_fees' => false,
        'generate_illustration_on_payments' => false,
        'firm_fees_label' => false,
        'consulting_services_label' => false,
        'date_updated' => false,
        'additional_portfolio_analytics' => false,
        'enable_multi_factor_authentication' => false,
    ...
    protected static $attributeMap = [
        ...
        'set_default_user_email_to_fundment' => 'set_default_user_email_to_fundment',
        'receives_consulting_services_fees' => 'receives_consulting_services_fees',
        'generate_illustration_on_payments' => 'generate_illustration_on_payments',
        'firm_fees_label' => 'firm_fees_label',
        'consulting_services_label' => 'consulting_services_label',
        'date_updated' => 'date_updated',
        'additional_portfolio_analytics' => 'additional_portfolio_analytics',
    ...
    protected static $setters = [
        ...
        'set_default_user_email_to_fundment' => 'setSetDefaultUserEmailToFundment',
        'receives_consulting_services_fees' => 'setReceivesConsultingServicesFees',
        'generate_illustration_on_payments' => 'setGenerateIllustrationOnPayments',
        'firm_fees_label' => 'setFirmFeesLabel',
        'consulting_services_label' => 'setConsultingServicesLabel',
        'date_updated' => 'setDateUpdated',
        'additional_portfolio_analytics' => 'setAdditionalPortfolioAnalytics',
        'enable_multi_factor_authentication' => 'setEnableMultiFactorAuthentication',
    ...
    protected static $getters = [
        ...
        'set_default_user_email_to_fundment' => 'getSetDefaultUserEmailToFundment',
        'receives_consulting_services_fees' => 'getReceivesConsultingServicesFees',
        'generate_illustration_on_payments' => 'getGenerateIllustrationOnPayments',
        'firm_fees_label' => 'getFirmFeesLabel',
        'consulting_services_label' => 'getConsultingServicesLabel',
        'date_updated' => 'getDateUpdated',
        'additional_portfolio_analytics' => 'getAdditionalPortfolioAnalytics',
        'enable_multi_factor_authentication' => 'getEnableMultiFactorAuthentication',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('set_default_user_email_to_fundment', $data ?? [], true);
        $this->setIfExists('receives_consulting_services_fees', $data ?? [], false);
        $this->setIfExists('generate_illustration_on_payments', $data ?? [], false);
        $this->setIfExists('firm_fees_label', $data ?? [], null);
        $this->setIfExists('consulting_services_label', $data ?? [], null);
        $this->setIfExists('date_updated', $data ?? [], null);
        $this->setIfExists('additional_portfolio_analytics', $data ?? [], false);
        $this->setIfExists('enable_multi_factor_authentication', $data ?? [], true);
    ...
    */
     ...
     * Sets io_tenant_id
     *
     * @param string|null $io_tenant_id io_tenant_id
     *
     * @return self
     */
    ...
    /**
     * Gets set_default_user_email_to_fundment
     *
     * @return bool|null
     */
    public function getSetDefaultUserEmailToFundment()
    {
        return $this->container['set_default_user_email_to_fundment'];
    }

    /**
     * Sets set_default_user_email_to_fundment
     *
     * @param bool|null $set_default_user_email_to_fundment set_default_user_email_to_fundment
     *
     * @return self
     */
    public function setSetDefaultUserEmailToFundment($set_default_user_email_to_fundment)
    {
        if (is_null($set_default_user_email_to_fundment)) {
            throw new \InvalidArgumentException('non-nullable set_default_user_email_to_fundment cannot be null');
        }
        $this->container['set_default_user_email_to_fundment'] = $set_default_user_email_to_fundment;

        return $this;
    }

    /**
     * Gets receives_consulting_services_fees
     *
     * @return bool|null
     */
    public function getReceivesConsultingServicesFees()
    {
        return $this->container['receives_consulting_services_fees'];
    }

    /**
     * Sets receives_consulting_services_fees
     *
     * @param bool|null $receives_consulting_services_fees receives_consulting_services_fees
     *
     * @return self
     */
    public function setReceivesConsultingServicesFees($receives_consulting_services_fees)
    {
        if (is_null($receives_consulting_services_fees)) {
            throw new \InvalidArgumentException('non-nullable receives_consulting_services_fees cannot be null');
        }
        $this->container['receives_consulting_services_fees'] = $receives_consulting_services_fees;

        return $this;
    }

    /**
     * Gets generate_illustration_on_payments
     *
     * @return bool|null
     */
    public function getGenerateIllustrationOnPayments()
    {
        return $this->container['generate_illustration_on_payments'];
    }

    /**
     * Sets generate_illustration_on_payments
     *
     * @param bool|null $generate_illustration_on_payments generate_illustration_on_payments
     *
     * @return self
     */
    public function setGenerateIllustrationOnPayments($generate_illustration_on_payments)
    {
        if (is_null($generate_illustration_on_payments)) {
            throw new \InvalidArgumentException('non-nullable generate_illustration_on_payments cannot be null');
        }
        $this->container['generate_illustration_on_payments'] = $generate_illustration_on_payments;

        return $this;
    }

    /**
     * Gets firm_fees_label
     *
     * @return string|null
     */
    public function getFirmFeesLabel()
    {
        return $this->container['firm_fees_label'];
    }

    /**
     * Sets firm_fees_label
     *
     * @param string|null $firm_fees_label firm_fees_label
     *
     * @return self
     */
    public function setFirmFeesLabel($firm_fees_label)
    {
        if (is_null($firm_fees_label)) {
            throw new \InvalidArgumentException('non-nullable firm_fees_label cannot be null');
        }
        $this->container['firm_fees_label'] = $firm_fees_label;

        return $this;
    }

    /**
     * Gets consulting_services_label
     *
     * @return string|null
     */
    public function getConsultingServicesLabel()
    {
        return $this->container['consulting_services_label'];
    }

    /**
     * Sets consulting_services_label
     *
     * @param string|null $consulting_services_label consulting_services_label
     *
     * @return self
     */
    public function setConsultingServicesLabel($consulting_services_label)
    {
        if (is_null($consulting_services_label)) {
            throw new \InvalidArgumentException('non-nullable consulting_services_label cannot be null');
        }
        $this->container['consulting_services_label'] = $consulting_services_label;
    ...
    /**
     * Gets additional_portfolio_analytics
     *
     * @return bool|null
     */
    public function getAdditionalPortfolioAnalytics()
    {
        return $this->container['additional_portfolio_analytics'];
    }

    /**
     * Sets additional_portfolio_analytics
     *
     * @param bool|null $additional_portfolio_analytics additional_portfolio_analytics
     *
     * @return self
     */
    public function setAdditionalPortfolioAnalytics($additional_portfolio_analytics)
    {
        if (is_null($additional_portfolio_analytics)) {
            throw new \InvalidArgumentException('non-nullable additional_portfolio_analytics cannot be null');
        }
        $this->container['additional_portfolio_analytics'] = $additional_portfolio_analytics;

        return $this;
    }

    /**
     * Gets enable_multi_factor_authentication
     *
     * @return bool|null
     */
    public function getEnableMultiFactorAuthentication()
    {
        return $this->container['enable_multi_factor_authentication'];
    }

    /**
     * Sets enable_multi_factor_authentication
     *
     * @param bool|null $enable_multi_factor_authentication enable_multi_factor_authentication
     *
     * @return self
     */
    public function setEnableMultiFactorAuthentication($enable_multi_factor_authentication)
    {
        if (is_null($enable_multi_factor_authentication)) {
            throw new \InvalidArgumentException('non-nullable enable_multi_factor_authentication cannot be null');
        }
        $this->container['enable_multi_factor_authentication'] = $enable_multi_factor_authentication;
